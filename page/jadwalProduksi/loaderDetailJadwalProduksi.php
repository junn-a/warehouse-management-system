		...
		<table class="table table-bordered" id="dataTable">
                ...
                <tbody>
                   <?php
					...
					$selectData 	= pg_query($conn,"SELECT detil_jadwal.*, master_produk.nama_produk FROM detil_jadwal INNER JOIN master_produk ON  detil_jadwal.kode_material=master_produk.kode_material WHERE detil_jadwal.tanggal_jadwal='$dateNew'");
					$no = 1;
					while($fetchData = pg_fetch_array($selectData)){
				   ?>
					<tr>
						<td><?=$no++?></td>
